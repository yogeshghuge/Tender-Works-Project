...
<body>
   ...
   <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
        ...
        <div class="marquee-content" style="align:center; padding-top:0px;min-height:450px;background-color:cyan">
     	<div class="item active"> <img src="images/Vendor.jpg" style="width:100%; height: 480px"> </div>
      </div>
     </div>
     </div>
