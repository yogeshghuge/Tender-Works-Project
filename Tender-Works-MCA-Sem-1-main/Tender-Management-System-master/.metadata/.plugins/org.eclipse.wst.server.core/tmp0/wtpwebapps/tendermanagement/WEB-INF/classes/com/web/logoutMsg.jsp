...
<body>
  <div class="col-md-8">
    <div class="marquee" style="border:2px black hidden; background-color:white">
      ...
      <!-- height="900" -->   
      <marquee scrollamount=0 style="min-height:450px">
            ...
            <div class="slider">
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="item active"> <img src="images/shishir.jpg" style="width:100%; height: 450px"> </div>
                
				<div class="item"> <img src="images/jcb.jpg" style="width:100%; height: 450px"> </div>
				<div class="item"> <img src="images/cap.jpg" style="width:100%; height: 450px"> </div>  
                <div class="item ctive"> <img src="images/qwerty.jpg" style="width:100%; height: 450px"> </div>
                </div>
